...
public class ProfileInterface extends Activity
{
    ...
    private ProfileInterface context;
    private User user;
    ...
    public void updateProfileInfo(String[] resp)
    {
        ...
        getProfileFeed(user.getUserId());
    }

    public void updateProfileFeed(String[] resp)
    {
        if(resp != null)
        {
            try
    ...
    public void getProfileFeed(String id)
    {
        try
        {
            Log.i("TEST","Getting user info");
            ProfileInfo task = new ProfileInfo(this, id);
            task.setArgs("1");
            task.execute();
    ...
    private class ProfileInfo extends AsyncTask<String, Void, Void >
    {
        private String[] resp;
        private String[] args;
        private String id;
        private ProfileInterface context;
        public ProfileInfo (ProfileInterface c, String id)
        {
            context = c;
            this.id = id;
        ...
        protected Void doInBackground(String... strings)
        {
            ...
            try
            {
                ...
                {
                    url = new URL("http://cislinux.cs.ksu.edu:5000/profileu");
        ...
        protected void onPostExecute(Void res)
        {
            ...
            if(args == null)
            {
                context.updateProfileInfo(resp);
            }
            else
            {
                context.updateProfileFeed(resp);
            }
        }
    }
